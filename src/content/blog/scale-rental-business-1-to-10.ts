...
const post: BlogPost = {
  slug: 'scale-short-term-rental-business-1-to-10-properties',
  title: 'How to Scale Your Short-Term Rental Business from 1 to 10 Properties',
  description: 'A practical roadmap for growing your short-term rental portfolio from a single property to 10+ units, covering systems, automation, and revenue management.',
  date: '2026-02-01',
  readingTime: 12,
  ...
  headings: [
    { id: 'the-one-to-three-transition', text: 'The 1-to-3 Transition: Building Your Foundation', level: 2 },
    { id: 'systems-before-scale', text: 'Systems Before Scale: The Automation Stack', level: 2 },
    { id: 'revenue-management-at-scale', text: 'Revenue Management at Scale', level: 2 },
    { id: 'three-to-five-operational-maturity', text: '3-to-5 Properties: Operational Maturity', level: 2 },
    { id: 'building-your-team', text: 'Building Your Team', level: 2 },
    { id: 'five-to-ten-the-business-phase', text: '5-to-10: The Business Phase', level: 2 },
    { id: 'financial-architecture', text: 'Financial Architecture for Growth', level: 2 },
    { id: 'common-scaling-mistakes', text: 'Common Scaling Mistakes to Avoid', level: 2 },
    { id: 'the-ten-property-milestone', text: 'The 10-Property Milestone', level: 2 },
  ],
  content: `
...
<h2 id="the-one-to-three-transition">The 1-to-3 Transition: Building Your Foundation</h2>
...
<h2 id="systems-before-scale">Systems Before Scale: The Automation Stack</h2>
...
<h2 id="revenue-management-at-scale">Revenue Management at Scale</h2>
...
<h2 id="three-to-five-operational-maturity">3-to-5 Properties: Operational Maturity</h2>
...
<h2 id="building-your-team">Building Your Team</h2>
...
<h2 id="five-to-ten-the-business-phase">5-to-10: The Business Phase</h2>
...
<h2 id="financial-architecture">Financial Architecture for Growth</h2>
...
<h2 id="common-scaling-mistakes">Common Scaling Mistakes to Avoid</h2>
...
<h2 id="the-ten-property-milestone">The 10-Property Milestone</h2>
